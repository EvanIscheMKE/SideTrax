...
{    
    ...
    NSString *jsonObjectString = [self encodeBase64:(uint8_t *)transactionReceipt.bytes
...
- (BOOL)isTransactionAndItsReceiptValid:(SKPaymentTransaction *)transaction {
    ...
    [_transactionsReceiptStorageDictionary setObject:purchaseInfoDict forKey:transactionId];
